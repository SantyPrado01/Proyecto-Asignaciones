...
def asignacion_actividad(texto_actividad, dibujo, texto_nombre, texto_ayudante, fuente, aclaraciones_entry, fuente_aclaraciones):
        ...
        if texto_actividad == "lectura":
            dibujo.rectangle([(53, 298), (65, 309)], fill="black", width=2)
            ban = 0
        elif texto_actividad == "primera conversacion":
            dibujo.rectangle([(53, 320), (65, 331)], fill="black", width=2)
            ban = 1
        elif texto_actividad == "revisita":
            dibujo.rectangle([(53, 365), (65, 376)], fill="#black", width=2)
            dibujo.text((85,340), aclaraciones_entry, fill=(0, 0, 0), font=fuente_aclaraciones)
            ban = 1
        elif texto_actividad == "curso biblico":
            dibujo.rectangle([(305, 298), (317, 309)], fill="black", width=2)
            dibujo.text((85,340), aclaraciones_entry, fill=(0, 0, 0), font=fuente_aclaraciones)
            ban = 1 
        elif texto_actividad == "discurso":
            dibujo.rectangle([(305, 320), (317, 331)], fill="black", width=2)
            ban = 0
        else:
            dibujo.text([(305, 343),(317, 354)], fill='black', width=2)
            dibujo.text((85,340), aclaraciones_entry, fill=(0, 0, 0), font=fuente_aclaraciones)
            ban = 1
...
def asignacion_sala(a,b,dibujo):
    if a.get():
        dibujo.rectangle([(53, 450), (65, 461)], fill="black", width=2)
    elif b.get():
        dibujo.rectangle([(53, 473),(65, 484)],fill="black",width=2)
