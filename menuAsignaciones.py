...
def generar_asignacion():
    global ingresar_semana_date, nombre_entry, ayudante_entry, dibujo, aclaraciones_entry, opcion_seleccionada, opcion_principal, opcion_auxiliar, mensaje_error, mensaje_completado_nombre  
    try:
...
option_menu = OptionMenu(ventana, opcion_seleccionada, *opciones_asignaciones)
option_menu.pack()
